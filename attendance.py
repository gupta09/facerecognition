...
class Attendance:
    def __init__(self,root):
        ...
        img=Image.open(r"college_image\21.jpg")
        img=img.resize((800,200),PIL.Image.LANCZOS)
        ...
        img1=Image.open(r"college_image\22.jpeg")
        ...
        img3=Image.open(r"college_image\23.jpg")
        ...
        title_lbl=Label(bg_image,text="ATTENDANCE",font=("times new roman",35,"bold"),bg="white",fg="purple")
