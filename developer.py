...
class Developer:
    def __init__(self,root):
        ...
        # Developer info
        dev_label=Label(main_frame,text="Hello My Name is Harsh",font=("times new roman",20,"bold"),bg="white")
        dev_label.place(x=0,y=5)
        
        dev_label=Label(main_frame,text="I am a full stack developer",font=("times new roman",20,"bold"),bg="white")
